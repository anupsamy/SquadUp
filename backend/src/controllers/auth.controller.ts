...
export class AuthController {
  async signUp(
    ...
    try {
      ...
      const validatedIdToken: string = idToken;

      const data = await authService.signUpWithGoogle(validatedIdToken);
  ...
  async signIn(
    ...
    try {
      ...
      const data = await authService.signInWithGoogle(validatedIdToken);
