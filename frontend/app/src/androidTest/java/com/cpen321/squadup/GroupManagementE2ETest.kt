...
class GroupManagementE2ETest {
    ...
    fun createGroup_mainSuccessScenario_groupCreatedSuccessfully() {
        ...
        composeTestRule.onNodeWithText("Select Meeting Date")
            .assertIsDisplayed()
            .performClick()
        ...
        composeTestRule.onNodeWithText("Select Meeting Time")
            .assertIsDisplayed()
            .performClick()
        ...
        composeTestRule.onNodeWithText("Select Activity Type")
            .assertIsDisplayed()
            .performClick()
    ...
    fun createGroup_withInvalidInputs_showsErrorPrompt() {
        ...
        composeTestRule.onAllNodesWithText("Create Group")
            .onLast()
            .assertIsDisplayed()
    ...
    fun joinGroup_withValidCode_joinsSuccessfully() {
        ...
        composeTestRule.onNodeWithContentDescription("Join Group")
            .assertIsDisplayed()
            .performClick()
        ...
        composeTestRule.onNodeWithText("Join Group")
            .assertIsDisplayed()
        
        // Step 2: Enter Join Code
        composeTestRule.onNodeWithText("Enter Join Code")
            .assertIsDisplayed()
            .performClick()
        ...
        composeTestRule.onNodeWithText("Check Group")
            .assertIsDisplayed()
            .assertIsEnabled()
            .performClick()
        ...
        composeTestRule.onAllNodesWithText("Join Group")
            .onLast()
            .assertIsDisplayed()
    ...
    fun joinGroup_withInvalidCode_showsError() {
        ...
        composeTestRule.waitForNodeWithText("Group not found. Please check the join code.", timeoutMillis = 3000)
            .assertIsDisplayed()
    }
    ...
    fun createAndViewGroup_completeFlow_groupAppearsInList() {
        ...
        composeTestRule.waitForNodeWithText("Back to Home", timeoutMillis = 20000)
            .performClick()
        ...
        composeTestRule.waitForNodeWithText(testGroupName, timeoutMillis = 10000)
            .assertIsDisplayed()
    }
}
