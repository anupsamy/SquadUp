...
import com.cpen321.squadup.data.remote.dto.AuthData
import com.cpen321.squadup.data.remote.dto.GoogleLoginRequest
import com.cpen321.squadup.data.remote.dto.User
import com.cpen321.squadup.utils.JsonUtils
...
class AuthRepositoryImpl
    ...
    constructor(
        ...
        private fun handleSignInWithGoogleOption(result: GetCredentialResponse): Result<GoogleIdTokenCredential> {
        ...
        override suspend fun doesTokenExist(): Boolean = tokenManager.getToken().first() != null

        override suspend fun getStoredToken(): String? = tokenManager.getTokenSync()
